...
/* Controllers */
var ctuControllers = angular.module('ctuControllers', [
		'ngStorage', 'ctuDirectives' ]);
...
ctuControllers.controller('fileUploadCtrl', [ '$scope',
		function($scope) {
			$scope.var1 = "Test scope";
		} ]);

ctuControllers.controller('invoiceListCtrl', [
		...
		ctuControllers.controller('imageListCtrl', [
	'$scope','ImageService',
